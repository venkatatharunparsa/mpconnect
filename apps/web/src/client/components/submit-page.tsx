...
export default function SubmitPage() {
  ...
  const respondVerification = async (verificationId: number, response: "confirm" | "deny") => {
    ...
    try {
      ...
      addBot(
        response === "confirm"
          ? `âœ… ${t(lang, "confirmFixed")}`
          : `âŒ ${t(lang, "denyNotFixed")} â€” demand reopened.`,
      );
